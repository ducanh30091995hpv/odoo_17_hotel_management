...
class RoomBookingWizard(models.TransientModel):
    ...
    check_all = fields.Boolean(string='Check All', help="Lấy tất cả")
    ...
    def get_xlsx_report(self, data, response):
        ...
        sheet.set_row(0, 30)
        sheet.set_row(1, 20)
        sheet.write("A2", "STT", cell_format)
        sheet.write("B2", "Khách hàng", cell_format)
        sheet.write("C2", "Phòng", cell_format)
        sheet.write("D2", "Check In", cell_format)
        sheet.write("E2", "Check Out", cell_format)
        sheet.write("F2", "Mã đặt phòng", cell_format)
        row = 2
        column = 0
        value = 1
